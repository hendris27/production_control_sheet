...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('production_control_shift1_5h', function (Blueprint $table) {
            ...
            // 🔹 Time Slots (vertical: 5 slots)
            for ($i = 1; $i <= 5; $i++) {
                $table->integer("target")->nullable();
                $table->integer("actual_ok")->nullable();
                $table->integer("ng")->nullable();
                $table->integer("balance")->nullable();
                $table->integer("loss_time")->nullable();
                $table->string("remarks")->nullable();
                $table->string("remarks_other")->nullable();
                $table->integer("target_acc")->nullable();
                $table->integer("actual_acc")->nullable();
                $table->integer("ng_acc")->nullable();
                $table->integer("balance_acc")->nullable();
                $table->integer("loss_acc")->nullable();
            }
